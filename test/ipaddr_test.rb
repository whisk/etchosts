...
class IPAddrTest < Test::Unit::TestCase
  context 'cat'  do
    ...
    should 'be private' do
      assert_equal :private, IPAddr.new('192.168.0.1').cat
      assert_equal :private, IPAddr.new('192.168.1.1').cat
      assert_equal :private, IPAddr.new('10.10.0.1').cat
      assert_equal :private, IPAddr.new('172.16.0.1').cat
    end
    ...
    should 'be allowed' do
      ...
      assert IPAddr.new('10.10.0.1').allowed?
    end
